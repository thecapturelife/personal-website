      ...
      <div className='flex flex-col md:flex-row h-full'>
        <div className='flex flex-col justify-center items-center md:items-start w-full md:w-1/2 px-4 md:px-16 py-8'>
          <div className="flex justify-center mb-6 md:mb-8">
            <div className="w-36 h-36 md:w-44 md:h-44 border-pink-300 rounded-full overflow-hidden border-4">
              <img src="albi2.jpg" alt="Profile Picture" className="w-full h-full object-cover" />
            </div>
          </div>
